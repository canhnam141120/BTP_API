namespace BTP_API.Services
{
    public interface IManageTransactionRepository
    {
        ...
        public Task<ApiMessage> updateRefundExchangeAsync(int exchangeBillId);
        ...
        public Task<ApiMessage> updateRefundRentAsync(int rentBillId);
        ...
        public Task<ApiMessage> autoTradingExchangeAsync();
        public Task<ApiMessage> autoTradingRentAsync();
    }
}
